...
- [Yoga Server](https://the-guild.dev/graphql/yoga-server/docs/integrations/integration-with-bun) - A fast, fully featured GraphQL Framework that [runs on Bun](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-bun), Cloudflare Workers, Deno, and any JS environment. 
...
- [feTS](https://the-guild.dev/openapi/fets/server/integrations/bun) - Create and consume APIs with e2e type safety using JSON Schema, OpenAPI and TypeScript
