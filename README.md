...
- [Milkio](https://github.com/akirarika/milkio) - A pleasant framework, less is more, no complex outdated concepts, and serverless first, end-to-end type safety, and having a pretty API reader to replace Swagger.
